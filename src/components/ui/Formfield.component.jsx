...
const FormField = ({
    ...
    switch (as) {
        case 'input':
            inputEle = <motion.input className={`${inputStyles}`} {...ElementConfig} value={value} onChange={onChange} />;
            break;
        case 'textarea':
            inputEle = <motion.textarea className={`${inputStyles} resize-none`} {...ElementConfig} value={value} onChange={onChange} />;
            break;
        case 'select':
            inputEle = <Select classname="my-2"/>;
            break;
        default:
            inputEle = <motion.input className={`${inputStyles}`} {...otherInpProps} value={value} onChange={onChange} />;
    }
